...
const Search = () => {
    ...
    const paragraphQuoteStyling = {
        margin: customSpacing.none,
        marginRight: customSpacing.m,
        fontSize: theme.typography.body1.fontSize,
    };
    const paragraphTrendStyling = {
        margin: customSpacing.none,
        fontSize: theme.typography.body1.fontSize,
    };
    ...
    const searchStock = async () => {
        ...
        const lastWeekDate = `${lastWeek.getFullYear()}-${(lastWeek.getMonth() + 1).toString().padStart(2, '0')}-${lastWeek.getDate().toString().padStart(2, '0')}`;
    ...
    return (
        ...
        >
            <div className="page__titles">
                ...
                >
                    Track the latest news, updates, and performance of your
            ...
            >
                <div className="search__input">
                    <FormControl variant="standard">
                        ...
                        <Input
                            ...
                            inputProps={{ 'data-testid': 'search__input' }}
                ...
                {loading === 'Finding Stock...' ? (
                    <p
                        className="loading"
                        style={{
                            marginTop: customSpacing.l,
                            fontSize: theme.typography.body1.fontSize,
                        }}
                    >
                        {loading}
                        ...
                        {Object.keys(profile).length && profile.name.length ? (
                            <div>
                                <div className="search__output-profile">
                                    ...
                                    />
                                    <div
                                        className="search__output-profile-data"
                        ...
                        {Object.keys(quote).length && quote?.c !== 0 ? (
                            <div>
                                <div className="search__output-quote">
                                    ...
                                    {quote?.pc && (
                                        <p style={paragraphQuoteStyling}>
                                            <span>Previous Close Price:</span>{' '}
                                            {money(quote?.pc)}
                                        </p>
                                    )}
                                    {quote?.c && (
                                        <p
                                            data-testid="output__current-price"
                                            style={paragraphQuoteStyling}
                                        >
                                    ...
                                    {trends.map((trend) => {
                                        return (
                                            <Card
                                                variant="outlined"
                                                data-type="trends"
                                                data-testid={`trends-${trend?.period}`}
                                                key={trend?.period}
                                                style={{
                                                    padding: customSpacing.s,
                                                }}
                                            >
                                                <p
                                                    style={
                                                        paragraphTrendStyling
                                                    }
                                                >
                                                    <span>Month:</span>{' '}
                                                    {new Date(
                        ...
                        {news.length ? (
                            <div>
                                <div className="search__output-news">
                                    ...
                                    >
                                        Recent updates on {profile?.name} from
                                        the past week.
                                    </p>
