...
const MyStocks = () => {
    ...
    useEffect(() => {
        ...
        if (myStocks !== null) {
            const temp = JSON.parse(myStocks);
            setMyStocks(temp);
        }
    }, []);
    ...
    return (
        ...
        >
            <div className="page__titles">
                ...
                >
                    Manage your stocks efficiently with personalized insights,
                    real-time data, and seamless tracking of your investment
                    portfolio.
                </Typography>
            </div>
            <div
                            ...
                            >
                                ...
                                <TableBody>
                                    {myStocks.map((stock, index) => {
                                        ...
                                        return (
                                            <TableRow
                                                key={stock.stock}
                                                data-testid={`stocklist-${stock.stock}`}
                                            >
                                                <TableCell
                                                    component="th"
                                                    scope="row"
                                ...
                                <TableFooter>
                                    <TableRow>
                                        ...
                                        <TableCell
                                            align="left"
                                            data-testid="total__bought__price"
                                        >
                                            {money(totalBoughtPrice(myStocks))}
                                        </TableCell>
                                        <TableCell
                                            align="left"
                                            data-testid="total__current__price"
                                        >
                                            {money(
                                                totalCurrentPrice(
                                                    myStocks,
                                        ...
                                        <TableCell
                                            align="left"
                                            data-testid="total__change__price"
                                            style={{
                                                fontSize:
